...
class RadialMenu(val skin: Skin, var radiusX: Float, var radiusY: Float) : Group() {
    ...
    var active = false
    var items = listOf<RadialMenuItem>()
    var deadzoneX = 0f
    var deadzoneY = 0f
    ...
    fun getSelected(xOff: Double, yOff: Double): RadialMenuItem? {
...
data class RadialMenuItem(val title: String, val onSelected: (WorldCoords) -> Unit) {

    override fun toString(): String {
        return "RadialMenuItem($title)"
    }
}
